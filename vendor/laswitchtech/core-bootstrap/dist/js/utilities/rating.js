...
sampleBuilder.Rating._callback = function(type, locale, level){
    console.log('['+locale+'] Missing Rating: '+type+' ['+level+']');
}

// Get a Rating Badge
$(document.createElement('div'))
    .append(sampleBuilder.Rating.badge('leads', 4))
    .prepend($(document.createElement('strong')).addClass('mx-1').text('[leads] [4]'))
    .appendTo('#example')

// Get an unknown Rating Badge
$(document.createElement('div'))
    .append(sampleBuilder.Rating.badge('prospects', 1))
    .prepend($(document.createElement('strong')).addClass('mx-1').text('[prospects] [1]'))
    .appendTo('#example')

// Set Locale to fr-ca
sampleBuilder.Rating.set('fr-ca');
...
// Set Locale to en-ca
sampleBuilder.Rating.set('en-ca');

// Parse a Rating Badge
$(document.createElement('div'))
    .append(sampleBuilder.Rating.parse('Parsing [[rating:leads:4]]'))
