            ...
            form.add({
                ...
                callback: {
                    condition: function(form){
                        console.log(form.val().shipper,form.val().shipper.toUpperCase());
                        // return form.val().shipper;
                        // return (form.val().shipper.toUpperCase() === "YES");
                        // return (form.val().shipper > 50);
                        // return (form.val().shipper.toUpperCase() === "<P>YES</P>");
                        return (form.val().shipper.toUpperCase() === "#FFFFFF");
                    }
                },
            }, function(input){});
        },
